        ...
        <div class="container-fluid">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <ul class="nav nav-tabs page-header-tab">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#Courses-all"
                  >List View</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#Courses-add"
                  >Add</a
                >
              </li>
              <li class="nav-item">
                ...
                >
                  <div class="card">
                    ...
                    <div class="card-body d-flex flex-column">
                      <h5>
                        <a href="courses-details.html">{{ course.name }}</a>
                      </h5>
                      ...
                      <table class="table table-striped table-vcenter mb-0">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-right">{{ course.credit }}</td>
                          </tr>
                          <tr>
...
<script src='./courses.component.js'>
<style scoped></style>;
