                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="page-timeline.html"
                      >Timeline</a
                    >
                    <a class="dropdown-item" href="page-invoices.html"
                      >Invoices</a
                    >
                    ...
                    <ul class="list-unstyled feeds_widget">
                      ...
                      <li>
                        ...
                        <div class="feeds-body ml-3">
                          <p class="text-muted mb-0">
                            New admission
                            <strong class="text-green font-weight-bold"
                              >32</strong
                            >
                      ...
                      <li>
                        ...
                        <div class="feeds-body ml-3">
                          <p class="text-muted mb-0">
                            New Feedback
                            <strong class="text-azure font-weight-bold"
                              >53</strong
                            >
                ...
                <div class="dropdown d-flex">
                  ...
                  >
                    <span
                      class="avatar"
                      style="
                        background-image: url(../assets/images/xs/avatar5.jpg);
                      "
                    ></span>
                    George</a
                  >
                      ...
                      >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <span class="tag tag-success ml-0 mr-0"
                                >High</span
                              >
                            </td>
                            <td>
