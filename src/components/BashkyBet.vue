...
<!--        &lt;!&ndash; Start Main leftbar navigation &ndash;&gt;-->
        <div id="left-sidebar" class="sidebar">
            <h5 class="brand-name">Online University<a href="javascript:void(0)" class="menu_option float-right"><i class="icon-grid font-16" data-toggle="tooltip" data-placement="left" title="Grid & List Toggle"></i></a></h5>
            <ul class="nav nav-tabs">
            ...
            <div class="tab-content mt-3">
                <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                    <nav class="sidebar-nav">
                        <ul class="metismenu">
                            <li class="active"><router-link to="/"><i class="fa fa-dashboard"></i><span>Dashboard</span></router-link></li>
                            <li><router-link to="/professors"><i class="fa fa-black-tie"></i><span>Professors</span></router-link></li>
                            <li><a href="staff.html"><i class="fa fa-user-circle-o"></i><span>Staff</span></a></li>
                            <li><router-link to="/about"><i class="fa fa-users"></i><span>Students</span></router-link></li>
                            <li><a href="departments.html"><i class="fa fa-users"></i><span>Departments</span></a></li>
                            <li><router-link to="/courses"><i class="fa fa-graduation-cap"></i><span>Courses</span></router-link></li>
